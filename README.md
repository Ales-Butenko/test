...
Привет! Меня зовут Алесь Бутенко, я начинающий аналитик данных. 
``{about_me_brief}``
...
2) Установил значение этого показателя по умолчанию как 100% и добавьте возможность изменять этот показатель для расчётного периода 05.21-04.22 по аналогии с другими 
...
<p>Задача №2 <p>
1) Добавил в калькулятор Найма преподавателей возможность изменять входных параметры: Пропускную способность П и Retention П 
2) Сделал поправку в расчёте общей пропускной способности 
...
<p>Что нужно было сделать:<p>
<ol>
  <li>Задача №1 созданием калькулятора юнит-экономики. </li>
</ol>

<p>Как решала(-а): 1. Кол-во подписок в каждый месяц       
...
> <a [href="https://drive.google.com/drive/folders/11HcEeqniyrCMjuwHZ0GLysX0A2SEv-_x"](https://drive.google.com/drive/folders/11fkjU2plrXix7oH9IUtNEme8LFkkCBHI?usp=sharing)>Ссылка на проект</a>
